...
def requests() do
  [
    %{
      ...
      body: "string",            # string. A string to send in the request body.
      body_file: "filepath"      # string. File path to body to send as request body.
      body_form: [               # list. List of two-element tuples of name-value pairs.
        {"name1", "value1"},
      ],
